...
_MoveToFOB = ["MoveToFOB", "<t color='#ff0000'>Move To FOB</t>","",{Player setPos (getPos FOBTELE);}, {!isNil "FOBTELE"}] call ace_interact_menu_fnc_createAction;
[this, 0, ["Respawn"], _MoveToFOB]  call ace_interact_menu_fnc_addActionToObject;
