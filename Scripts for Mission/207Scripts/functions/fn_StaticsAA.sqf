...
sleep 1;
[parseText "<t align='center' shadow='2' size='4'><t color='#2e2790'>Unpacking Spike AA</t></t><br/>", [0,0.7,1,0.5], nil, 7, 0.7, 0] spawn BIS_fnc_textTiles;
_Mortar = [[_mainbox, "GROUND"], "ADFRC_rbs70", 1, [0,-0.25,0], 0,{0},false] call BIS_fnc_spawnObjects;
sleep 2;
[parseText "<t align='center' shadow='2' size='4'><t color='#2e2790'>Unpacking Spike AA Ammo</t></t><br/>", [0,0.7,1,0.5], nil, 7, 0.7, 0] spawn BIS_fnc_textTiles;
...
_MortarAmmo addItemCargoGlobal ["Titan_AA", 8];
sleep 2;
_delammo = _Mortar select 0 nearSupplies 5;
{
if (typeOf _x == "ace_csw_ammo_holder") then {deleteVehicle _x;};
} forEach _delammo;
[parseText "<t align='center' shadow='2' size='4'><t color='#2e2790'>Spike AA has been unpacked</t></t><br/>", [0,0.7,1,0.5], nil, 7, 0.7, 0] spawn BIS_fnc_textTiles;