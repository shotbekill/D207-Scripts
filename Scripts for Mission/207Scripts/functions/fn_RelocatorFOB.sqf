...
private _Laptop = [[_CampingTableOB, "TOP"],"Land_Laptop_device_F",1,[0, 0, 0],0,{0},false] call BIS_fnc_spawnObjects;
private _LaptopOB = _Laptop select 0;
private _RelocatorLapTop = ["RelocatorLapTop","<t color='#207207'>FOB LapTop</t>","",{nil},{true},{},[],[0, 0, 0],7] call ace_interact_menu_fnc_createAction;
