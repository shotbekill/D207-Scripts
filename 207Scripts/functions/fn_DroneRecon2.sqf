...
_box addItemCargoGlobal ["GX_DEPLOYABLE_MAGAZINE_UAV_01", 10];
_box addItemCargoGlobal ["GX_DEPLOYABLE_MAGAZINE_BLACKHORNET_UAV", 20];
_box addItemCargoGlobal ["GX_DEPLOYABLE_MAGAZINE_RQ11B_UAV", 5];
_box addItemCargoGlobal ["GX_1RND_DRONE40_RECON_M203", 20];
_box addItemCargoGlobal ["GX_UAVBattery", 50];
sleep 1;
