params ["_packerbox"];
_nearestObjects = nearestObjects [player, ["Air"], 15];
_victopack = _nearestObjects select 0;
if (isNil "_victopack") exitWith {systemChat "No Airframe within 15M to Pack";};
if (typeOf _victopack == "ACE_friesAnchorBar") then {_victopack = _nearestObjects select 1;};
if (typeOf _victopack == "ACE_friesAnchorBar") exitWith {systemChat "No Airframe within 15M to Pack";};
...
_packbox = "B_Slingload_01_Cargo_F" createVehicle position player;
